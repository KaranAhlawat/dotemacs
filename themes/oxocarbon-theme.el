;;; oxocarbon-theme.el --- Trying to port oxocarbon-theme from nvim over
;;; Commentary:
;;; Code:
...
(autothemer-deftheme
 ...
 (
  ...
  (font-lock-variable-use-face (:foreground oxocarbon-base04)) ;; variable usage
  (font-lock-comment-face (:foreground oxocarbon-base03 :slant 'italic)) ;; comments
  ...
  (font-lock-function-call-face (:foreground oxocarbon-base08)) ;; function calls
  (font-lock-preprocessor-face (:foreground oxocarbon-base09))
  (font-lock-doc-face (:foreground oxocarbon-base14 :slant 'italic))
